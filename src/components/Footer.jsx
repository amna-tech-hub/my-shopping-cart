        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Electronics</a></li>
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Jewelry</a></li>
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Men's Clothing</a></li>
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Women's Clothing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Help Center</a></li>
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Safety Information</a></li>
              <li><a href="#" className="text-gray-600 hover:text-teal-700 text-sm transition">Cancellation Options</a></li>
            </ul>
          </div>
